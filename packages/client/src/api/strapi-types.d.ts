  ...
  ? Utils.Expression.MatchFirst<
      [
        [
          ...
          TRelationKind extends `${string}ToMany` ? Omit<APIResponseCollection<TTarget>, 'meta'> : APIResponse<TTarget>,
        ],
      ],
...
type ComponentValue<TAttribute extends Attribute.Attribute> = TAttribute extends Attribute.Component<
  infer TComponentUID,
  infer TRepeatable
>
...
type DynamicZoneValue<TAttribute extends Attribute.Attribute> = TAttribute extends Attribute.DynamicZone<
